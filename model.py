...
x_test, yyyyyy, filenames = importBatch(500, 0, 0, 'test', SCALE) 
...
with tf.device('/cpu:0'): #device:GPU:1
    ...
    with tf.Session(config=config) as sess:
        model = keras.models.load_model('program/02-simple-resnet-tver.hdf5', custom_objects={'tversky_loss': tversky_loss, 'iou_loss_core': iou_loss_core})
